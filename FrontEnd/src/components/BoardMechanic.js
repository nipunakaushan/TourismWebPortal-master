    ...
    return (
        <Modal style={{marginTop: '40px'}} show={showEdit} onHide={handleCloseEdit}>
                    <Modal.Header closeButton>
                        <Modal.Title>Edit Part Details</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                    ...
                    <div className="form-group">
                        <label htmlFor="price">Name of the part</label>
                        <Input
                            type="text"
                    ...
                    <div className="form-group">
                        <label htmlFor="size">Amount of cost</label>
                        <Input
                            type="text"
                            className="form-control"
                            name="size"
    ...
    return (
        ...
        <Row>
            <Col md={12}>
                ...
                <Button onClick={handleShow}>Add Replaced Part</Button>
                <Toast style={{ float: 'right', backgroundColor: 'green', color: '#ffff'}} show={showToast} delay={3000} autohide animation>
                        <Toast.Body>Vehicle part added successfully!</Toast.Body>
                </Toast>
                ...
                <Modal style={{marginTop: '40px'}} show={show} onHide={handleClose}>
                    <Modal.Header closeButton>
                        <Modal.Title>Add Part Details</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                    ...
                    <div className="form-group">
                        <button className="btn btn-primary btn-block">Add Part</button>
                    </div>
    ...
    useEffect(() => {
        ...
        if(user){
            PartService.getAllParts().then((response) => {
                setAllData(response.data.data.filter(e => e.mechanicId === user.data.user._id));
            });
...
console.log(content);
    ...
    const handleRegister = (e) => {
        ...
        if(checkBtn.current.context._errors.length === 0){
            PartService.addPart(content.data._id,content.data.name,description,price,maxGroupSize,imageUrl).then((response) => {
    ...
    const handleRegisterEdit = (e) => {
        ...
        if(checkBtn.current.context._errors.length === 0){
            PartService.updatePart(selectedId,description,price,maxGroupSize).then((response) => {
